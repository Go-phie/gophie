...
func main() {
	...
	const (
		...
		//    seleniumPath    = "selenium/vendor/selenium-server-standalone-3.4.jar"
		//    geckoDriverPath = "selenium/vendor/geckodriver"
		port = 4444
	)
	...
	if err := wd.Get("https://thenetnaija.com/videos/movies"); err != nil {
		panic(err)
	}
